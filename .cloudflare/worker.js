...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${[
        "sticky top-0 z-50 px-6 py-6 lg:px-8 transition-colors border-gray-200 dark:border-gray-700",
        "  "
      ].join(" ").trim()}"><div><nav class="${"flex h-9 items-center justify-between"}" aria-label="${"Global"}"><div class="${"flex lg:min-w-0 lg:flex-1"}" aria-label="${"Global"}"><a href="${"/"}" class="${"-m-1.5 p-1.5"}"><span class="${"sr-only"}">\u0420\u0430\u0441\u043F\u0430\u0437\u043D\u0430\u0432\u0430\u043D\u043D\u0435 \u043C\u0430\u043B\u044E\u043D\u043A\u0430\u045E</span>
                    <img class="${"h-12"}" src="${"/logo_lbsu.svg"}" alt="${""}"></a></div>
            <div class="${"flex lg:hidden"}"></div>
            <div class="${"hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12"}"><a data-sveltekit-preload-data="${"hover"}" href="${"/"}" class="${"font-semibold text-gray-900 hover:text-gray-900 transition-colors dark:text-gray-100 dark:hover:text-gray-300"}">\u0413\u0430\u043B\u043E\u045E\u043D\u0430\u044F</a>

                <a data-sveltekit-preload-data="${"hover"}" href="${"/demo"}" class="${"font-semibold text-gray-900 hover:text-gray-900 transition-colors dark:text-gray-100 dark:hover:text-gray-300"}">\u0414\u044D\u043C\u0430\u043D\u0441\u0442\u0440\u0430\u0446\u044B\u044F</a>

                </div>
            <div class="${"hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end"}"></div></nav>
        </div></div>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-dee0e7c6.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-dee0e7c6.js", "_app/immutable/chunks/index-c2b3dfa9.js"];
    stylesheets = ["_app/immutable/assets/_layout-3f038a4c.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-6c5f1f6a.js";
    imports2 = ["_app/immutable/components/error.svelte-6c5f1f6a.js", "_app/immutable/chunks/index-c2b3dfa9.js", "_app/immutable/chunks/singletons-52cd424f.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
  ...
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.ssr === void 0 && $$bindings.ssr && ssr !== void 0)
        $$bindings.ssr(ssr);
      if ($$props.csr === void 0 && $$bindings.csr && csr !== void 0)
        $$bindings.csr(csr);
      if ($$props.data === void 0 && $$bindings.data && data !== void 0)
        $$bindings.data(data);
      return `${$$result.head += `<!-- HEAD_svelte-62ijl_START -->${$$result.title = `<title>\u0420\u0430\u0441\u043F\u0430\u0437\u043D\u0430\u0432\u0430\u043D\u043D\u0435 \u043F\u0430\u0445\u043E\u0434\u0436\u0430\u043D\u043D\u044F \u0432\u044B\u044F\u0432\u0430\u045E</title>`, ""}<!-- HEAD_svelte-62ijl_END -->`, ""}


<div class="${"isolate"}"><div class="${"absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]"}"><svg class="${"relative left-[calc(50%-11rem)] -z-10 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-30rem)] sm:h-[42.375rem]"}" viewBox="${"0 0 1155 678"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path fill="${"url(#45de2b6b-92d5-4d68-a6a0-9b9b2abad533)"}" fill-opacity="${".3"}" d="${"M317.219 518.975L203.852 678 0 438.341l317.219 80.634 204.172-286.402c1.307 132.337 45.083 346.658 209.733 145.248C936.936 126.058 882.053-94.234 1031.02 41.331c119.18 108.451 130.68 295.337 121.53 375.223L855 299l21.173 362.054-558.954-142.079z"}"></path><defs><linearGradient id="${"45de2b6b-92d5-4d68-a6a0-9b9b2abad533"}" x1="${"1155.49"}" x2="${"-78.208"}" y1="${".177"}" y2="${"474.645"}" gradientUnits="${"userSpaceOnUse"}"><stop stop-color="${"#f0e639"}"></stop><stop offset="${"1"}" stop-color="${"#d9333f"}"></stop></linearGradient></defs></svg></div>
    <main><div class="${"relative"}"><div class="${"mx-auto max-w-3xl py-16 sm:pt-48 sm:pb-16 px-6 lg:px-8"}"><div><div class="${"hidden sm:mb-8 sm:flex sm:justify-center"}"><div class="${"relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:ring-gray-100/20 dark:hover:ring-gray-100/30"}"><span class="${"text-gray-600 dark:text-gray-300"}">\u0414\u044D\u043C\u0430\u043D\u0441\u0442\u0440\u0430\u0446\u044B\u044F \u043C\u0430\u0434\u044D\u043B\u0456 \u0440\u0430\u0441\u043F\u0430\u0437\u043D\u0430\u0432\u0430\u043D\u043D\u044F <a data-sveltekit-preload-data="${"hover"}" href="${"/demo"}" class="${"font-semibold text-blue-600"}"><span class="${"absolute inset-0"}" aria-hidden="${"true"}"></span>\u041F\u0430\u0433\u043B\u044F\u0434\u0437\u0435\u0446\u044C <span aria-hidden="${"true"}">\u2192</span></a></span></div></div>
                    <div><h1 class="${"text-4xl font-bold tracking-tight sm:text-center sm:text-6xl dark:text-gray-100"}">\u0420\u0430\u0441\u043F\u0430\u0437\u043D\u0430\u0432\u0430\u043D\u043D\u0435 \u043F\u0430\u0445\u043E\u0434\u0436\u0430\u043D\u043D\u044F \u0432\u044B\u044F\u045E</h1>
                        <p class="${"mt-6 text-lg leading-8 text-gray-600 sm:text-center dark:text-gray-400"}">\u0421\u044D\u0440\u0432\u0456\u0441 \u0432\u044B\u043A\u0430\u0440\u044B\u0441\u0442\u043E\u045E\u0432\u0430\u0435 CNN-\u043C\u0430\u0434\u044D\u043B\u044C, \u043A\u0430\u0431 \u0432\u044B\u0437\u043D\u0430\u0447\u044B\u0446\u044C
                         \u043F\u0430\u0445\u043E\u0434\u0436\u0430\u043D\u043D\u0435 \u0432\u044B\u044F\u045E: \u0446\u0456 \u044F\u043D\u044B \u0441\u0442\u0432\u043E\u0440\u0430\u043D\u044B \u0447\u0430\u043B\u0430\u0432\u0435\u043A\u0430\u043C, \u0446\u0456 \u0448\u0442\u0443\u0447\u043D\u044B\u043C \u0456\u043D\u0442\u044D\u043B\u0435\u043A\u0442\u0430\u043C.</p>
                        <div class="${"mt-8 flex gap-x-4 sm:justify-center"}"><a data-sveltekit-preload-data="${"hover"}" href="${"/demo"}" class="${"inline-block rounded-lg bg-blue-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-blue-600 hover:bg-blue-700 hover:ring-blue-700"}">\u0414\u044D\u043C\u0430\u043D\u0441\u0442\u0440\u0430\u0446\u044B\u044F
                                <span class="${"text-blue-200 hidden md:inline-flex"}" aria-hidden="${"true"}">\u2192</span></a>
                            </div></div>
                    <div class="${"absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"}"><svg class="${"relative left-[calc(50%+3rem)] h-[21.1875rem] max-w-none -translate-x-1/2 sm:left-[calc(50%+36rem)] sm:h-[42.375rem]"}" viewBox="${"0 0 1155 678"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path fill="${"url(#ecb5b0c9-546c-4772-8c71-4d3f06d544bc)"}" fill-opacity="${".3"}" d="${"M317.219 518.975L203.852 678 0 438.341l317.219 80.634 204.172-286.402c1.307 132.337 45.083 346.658 209.733 145.248C936.936 126.058 882.053-94.234 1031.02 41.331c119.18 108.451 130.68 295.337 121.53 375.223L855 299l21.173 362.054-558.954-142.079z"}"></path><defs><linearGradient id="${"ecb5b0c9-546c-4772-8c71-4d3f06d544bc"}" x1="${"1155.49"}" x2="${"-78.208"}" y1="${".177"}" y2="${"474.645"}" gradientUnits="${"userSpaceOnUse"}"><stop stop-color="${"#1ec2e2"}"></stop><stop offset="${"1"}" stop-color="${"#75ba39"}"></stop></linearGradient></defs></svg></div></div></div></div></main></div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-def4a8d1.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-def4a8d1.js", "_app/immutable/chunks/index-c2b3dfa9.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/demo/_page.svelte.js
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/demo/_page.svelte.js"() {
    ...
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.csr === void 0 && $$bindings.csr && csr !== void 0)
        $$bindings.csr(csr);
      return `${$$result.head += `<!-- HEAD_svelte-6dnspc_START -->${$$result.title = `<title>\u0414\u044D\u043C\u0430\u043D\u0441\u0442\u0440\u0430\u0446\u044B\u044F</title>`, ""}<!-- HEAD_svelte-6dnspc_END -->`, ""}

<div class="${"flex flex-col space-y-4 px-2 md:flex-row md:space-x-4 md:space-y-0 md:items-start md:py-8 items-center justify-center"}"><div class="${"w-full h-fit md:w-96 rounded-lg flex items-center justify-center border-2 border-gray-300 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 shadow-lg overflow-hidden"}">${`<p class="${"py-8 md:py-0 md:h-96 md:flex md:items-center md:justify-center"}">\u0410\u0431\u044F\u0440\u044B\u0446\u0435 \u0432\u044B\u044F\u0432\u0443
            </p>`}</div>
    <div class="${"w-full md:w-96 h-fit rounded-lg flex flex-col space-y-4 items-center justify-start border bg-white shadow-lg p-4 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"}"><div class="${"flex flex-col w-full"}"><label class="${"block mb-2 text-sm font-medium"}" for="${"file_input"}">\u0410\u0431\u0440\u0430\u0446\u044C
                \u0432\u044B\u044F\u0432\u0443</label>
            <input class="${"block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer file:cursor-pointer bg-gray-50 focus:outline-none file:bg-gray-700 file:text-gray-200 file:border-0 file:rounded-l-lg file:px-2 file:py-1.5 hover:file:bg-gray-900 file:transition-colors file:ease-in-out dark:border-gray-700 dark:text-gray-200 dark:bg-gray-800 dark:hover:file:bg-gray-600"}" aria-describedby="${"file_input_help"}" id="${"file_input"}" type="${"file"}" accept="${"image/*"}">
            <p class="${"mt-1 text-sm text-gray-500 dark:text-gray-300"}" id="${"file_input_help"}">\u041B\u0435\u043F\u0448 \u0433\u0440\u0443\u0437\u0456\u0446\u044C JPEG \u0446\u0456 PNG</p></div>
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file4 = "_app/immutable/components/pages/demo/_page.svelte-0d311198.js";
    imports4 = ["_app/immutable/components/pages/demo/_page.svelte-0d311198.js", "_app/immutable/chunks/index-c2b3dfa9.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/do/_page.svelte.js
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    file5 = "_app/immutable/components/pages/do/_page.svelte-c92423d5.js";
    imports5 = ["_app/immutable/components/pages/do/_page.svelte-c92423d5.js", "_app/immutable/chunks/index-c2b3dfa9.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});
...
var init_page_svelte4 = __esm({
  ".svelte-kit/output/server/entries/pages/privacy/_page.svelte.js"() {
    ...
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.csr === void 0 && $$bindings.csr && csr !== void 0)
        $$bindings.csr(csr);
      return `${$$result.head += `<!-- HEAD_svelte-1ordj2u_START -->${$$result.title = `<title>PicturesqueAI - Privacy Policy</title>`, ""}<!-- HEAD_svelte-1ordj2u_END -->`, ""}

<div class="${"px-4 sm:px-6 lg:px-8"}"><div class="${"relative mx-auto max-w-[37.5rem] pt-20 text-center pb-16"}"><h1 class="${"text-4xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100 sm:text-5xl"}">Privacy policy</h1>
        <p class="${"mt-4 text-base leading-7 text-slate-600 dark:text-slate-400"}">Last updated on December 10, 2022</p></div></div>
<div class="${"relative px-4 sm:px-6 lg:px-8 pb-24"}"><div class="${"mx-auto max-w-[40rem] prose-sm prose prose-slate text-slate-600 dark:text-slate-300 dark:prose-h2:text-slate-200 prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600"}"><p>Andrei Kasila and Pavel Kasila (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operate PicturesqueAI (application identifier:
            6444961785, the &quot;App&quot;). This page informs you of our policies regarding the collection, use and disclosure
            of Personal Information we receive from users of the App.
        </p>
        <p>We use your Personal Information only for providing and improving the App. By using the App, you agree to
            the collection and use of information in accordance with this policy.
        </p>

        <h2>Information Collection And Use</h2>
        <p>While using our App, we may ask you to provide us with certain personally identifiable information that can
            be used to contact or identify you. Personally identifiable information may include, but is not limited to
            your device identifier (&quot;Personal Information&quot;).
        </p>

        <h2>Log Data</h2>
        <p>Like many app operators, we collect information that your device sends whenever you visit our App (&quot;Log
            Data&quot;).
        </p>
        <p>This Log Data may include information such as your device&#39;s Internet Protocol (&quot;IP&quot;) address, operating
            system version, the API endpoints of our App that you request while using our App, the time and date of your
        ...
        <p>This Privacy Policy is effective as of December 10, 2022 and will remain in effect except with respect to
        ...
        <p>If we make any material changes to this Privacy Policy, we will notify you either through the email address
            you have provided us, or by placing a prominent notice on our app\u2019s page.
        </p>

        <h2>Contacting us</h2>
        <p>If you have any questions about this Policy, please contact us by email at
            <a class="${"text-orange-600 font-medium"}" href="${"mailto:pavel.kasila@gmail.com"}">pavel.kasila@gmail.com</a>.</p></div></div>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    file6 = "_app/immutable/components/pages/privacy/_page.svelte-51820e3a.js";
    imports6 = ["_app/immutable/components/pages/privacy/_page.svelte-51820e3a.js", "_app/immutable/chunks/index-c2b3dfa9.js"];
    stylesheets6 = [];
    fonts6 = [];
  }
});
...
async function render_response({
  ...
  const fonts7 = new Set(options.manifest._.entry.fonts);
...
var app_template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width" />\n		' + head + `
		<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7000320808293194"
				crossorigin="anonymous"><\/script>
		<!-- Google tag (gtag.js) -->
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-WKZ68JQ1CQ"><\/script>
		<script>
			window.dataLayer = window.dataLayer || [];
			function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());

			gtag('config', 'G-WKZ68JQ1CQ');
		<\/script>
	</head>
...
var manifest = {
  appDir: "_app",
  appPath: "_app",
  assets: /* @__PURE__ */ new Set(["favicon.png", "logo.png", "logo_lbsu.svg", "robots.txt"]),
  mimeTypes: { ".png": "image/png", ".svg": "image/svg+xml", ".txt": "text/plain" },
  _: {
    entry: { "file": "_app/immutable/start-e11400e9.js", "imports": ["_app/immutable/start-e11400e9.js", "_app/immutable/chunks/index-c2b3dfa9.js", "_app/immutable/chunks/singletons-52cd424f.js"], "stylesheets": [], "fonts": [] },
    nodes: [
